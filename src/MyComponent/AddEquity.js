...
const AddEquity = () => {
    ...
    const handleClick=(e)=>{
        ...
        console.log(data);
        axios.post("http://localhost:5072/Equity", data)
        .then((response) => {
    ...
    <div>
                    ...
                    <div className="form-container">
                      ...
                      <label>Security Name:</label>
                        ...
                        <input type="int" id="text" name="field5" class="right-align" value={formData.field5} onChange={handleInputChange}/><br/><br/>
                        ...
                        <input type="date" id="datetime" name="field59" value={formData.field59} onChange={handleInputChange}/><br/><br/>
                        <label >Amount:</label>
